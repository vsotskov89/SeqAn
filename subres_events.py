rom scipy.ndimage.filters import gaussian_filter1d
...
def SearchEventsInTraces(time, traces, opts):
    events = []                       #this is for sparse event storage in pickle 
    ...
    for cell_num, trace in enumerate(traces):
        #smoothing for a peak searching
