function [rotated_image]=rotate_image_interp(ref_image,theta,translations,center_of_FOV)
...
rotated_image=zeros(size(ref_image));
for p=1:N
    for q=1:M
        ...
        rotated_image(p,q)=interpolate_pixel_value(ref_image,wanted_coords);
    end
end
end
