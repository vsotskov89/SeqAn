...
% MODIF CATHIE : change how the baseline is subtracted            
...
%             ck_raw = ck_raw -b;
            ...
            [ck_raw, ~] = remove_baseline_sliding_window(ck_raw, 10, deconv_options.window_baseline);
            % [~, sn] = estimate_baseline_noise(ck_raw); 
