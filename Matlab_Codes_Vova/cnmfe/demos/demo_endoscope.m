...
nam = '.\Substack_cropped-02.tif';
%nam = './Substack_corr-02_with_mask.tif';
...
gSig = 8; %5;           % width of the gaussian kernel, which can approximates the average neuron shape
gSiz = 21; %18;          % maximum diameter of neurons in the image plane. larger values are preferred.
