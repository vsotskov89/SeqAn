...
Params.test10 =0;
%% Folders
Params.DataFolder = 'G:\Souris133656\21-03-08\135948_sCMOS_133656-awake\CorrNeurons2\4-Results\';                        % Folder where the data folders are located
Params.XLSsFolder = '\mnt\cortex-data-97\Calcium\XLSs\';    % Folder where the XLSs are saved
Params.PDFsFolder = 'G:\Souris133656\21-03-08\135948_sCMOS_133656-awake\CorrNeurons2\4-Results\';    % Folder where the PDFs are saved
...
%% Events Detection
Params.Method.SmallEvents = 'SE';               % 'noSE' ; 'SE' ; 'improvedSE'
...
Params.PrintPDFs = 0;                       % 1 : prints pdf, 0 does not. /!\ Folder must not contain .pdf ; pdfs will be saved in folder then merged and resulting pdf will be moved in containing directory
