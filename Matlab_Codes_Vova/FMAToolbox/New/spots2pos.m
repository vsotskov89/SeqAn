...
%     'temp'        save temp spots file after you've cleaned it (default = false)
%    =========================================================================
%
%  NOTES
%
...
for i = 1:length(bases),
	new = ProcessOne([path '/' bases{i}],inputFrequency,outputFrequency,resolution,threshold,leds,saveTemp);
...
function output = ProcessOne(basename,inputFrequency,outputFrequency,resolution,threshold,leds,saveTemp)
