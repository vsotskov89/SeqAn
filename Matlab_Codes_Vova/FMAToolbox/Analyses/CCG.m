...
%                   (see EXAMPLE #2 below)
%     'range'     optional vector giving the range of possible IDs. This
%                   is in case some units have not fired a spike within the
%                   interval, but they should not be omitted so that the 
%                   overall numbering of IDs is preserved. The vector should
%                   contain 2 values for normal (ungrouped) ccg and 4
%                   values for grouped ccg.
